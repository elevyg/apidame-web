    ...
    <main className="flex flex-col bg-paper text-ink">
      ...
      <section id="fotos" className="border-t border-rule py-20 md:py-28">
        <div className="page-shell">
          ...
          <div className="mt-10 grid grid-cols-2 gap-6 md:grid-cols-4 md:gap-8">
            {deportivaShots.map((shot) => (
              <ProjectDoor
                key={shot.file}
                src={`/estetica/deportiva/${shot.file}`}
                alt={shot.title}
                title={shot.title}
                score={shot.score}
                use={shot.use}
          ...
          <div className="mt-10 grid grid-cols-2 gap-6 md:grid-cols-4 md:gap-8">
            {presentacionShots.map((shot) => (
              <ProjectDoor
                key={shot.file}
                src={`/estetica/presentacion/${shot.file}`}
                alt={shot.title}
                title={shot.title}
                note={shot.note}
              />
